...
export default QuizBack = ({ backOpacity, backText, onCorrect, onIncorrect }) => (
  <View style={[styles.container, {opacity: backOpacity}]}>
    <View style={{flex: 2, justifyContent: 'center', alignItems: 'center'}}>
      <Text style={{textAlign: 'center', fontSize: 32, color: 'black'}}>{backText}</Text>
    </View>
    <View style={{flex: 1, justifyContent: 'center'}}>
      <TouchableOpacity style={{backgroundColor: '#2196F3', borderRadius: 2, padding: 8, marginVertical: 8, }} onPress={onCorrect}>
